...
<div class="bg-zinc-200 dark:bg-zinc-950/80 rounded-lg border border-zinc-800/25 overflow-hidden transition-all shadow-[3px_3px_0px_#1e40af,6px_6px_0px_#a8e600] dark:shadow-[3px_3px_0px_#2563eb,6px_6px_0px_#a8e600] hover:translate-x-1 hover:translate-y-1">
    ...
    <div class="flex items-center justify-between px-4 py-3 bg-zinc-900 border-b border-zinc-800">
        ...
        <div class="h-3 w-3 rounded-full bg-[#25C63A]"></div>
        </div>
    ...
    <div class="px-1 py-1.5">
        <h3 class="text-lg font-bold capitalize mb-2">{project.title}</h3>
