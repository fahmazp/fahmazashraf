    ...
    <div className="flex flex-col items-center gap-3">  
      <div className="flex flex-wrap items-center justify-center gap-2">
        ...
        <a
          ...
          className="w-11 h-11 rounded-sm flex items-center justify-center bg-white border transition p-0.5"
        >
        <svg xmlns="http://www.w3.org/2000/svg" className="text-[#0A66C2] hover:text-black" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-11 h-11 rounded-sm flex items-center justify-center bg-green-500 transition p-0.5"
        >
          ...
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className="text-white hover:text-black" viewBox="0 0 24 24">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-11 h-11 rounded-sm flex items-center justify-center bg-zinc-950 hover:bg-gray-50 transition p-1.5"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="text-white hover:text-zinc-950" viewBox="0 0 1200 1227">
