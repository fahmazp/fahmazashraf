import { CheckCheck, LinkedinIcon, MailIcon, Twitch, Twitter, TwitterIcon } from "lucide-react";
...
export default function FooterChatLinks() {
  return (
    <div className="flex flex-col sm:flex-row items-center sm:items-start justify-center sm:justify-between gap-4 max-w-6xl mx-auto pt-4 px-1">
      ...
      <div className="flex items-start gap-2 w-full sm:w-auto">
        ...
        <div className="flex flex-col gap-1.5 w-full max-w-[320px] leading-1.5">
          ...
          <div className="border bg-gray-50 dark:bg-zinc-950 px-2 py-1.5 text-sm rounded-sm border-gray-400 max-sm:max-w-[90%]">
            ...
            <div>Reach out via any of the links!</div>
          </div>
      ...
      {/* Footer Links Styled Like Screenshot */}
      <div className="flex flex-wrap items-center gap-2">
        {/* Email */}
        <a
          href="mailto:fahmazashraf7@gmail.com"
          className="h-12 w-24 rounded-sm flex items-center justify-center bg-red-500 text-white border-2 border-red-200 hover:bg-red-600 transition"
        >
          <MailIcon/>
        </a>
        ...
        <a
          ...
          className="size-12 rounded-sm flex items-center justify-center bg-white text-black border hover:bg-gray-100 transition p-0.5"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="size-12 rounded-sm flex items-center justify-center bg-white text-black border hover:bg-gray-950 hover:text-white transition p-1.5"
        >
