...
const ButtonHover12 = () => {
  return (
    <>
      <button className="hidden sm:block group h-8 select-none rounded-full bg-black text-white bg-gradient-to-b from-zinc-800 via-zinc-900 to-zinc-600 px-3 text-sm leading-8 
